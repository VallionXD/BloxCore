--[[
	BloxCore Interface | The library that handles creating the amazing interface used in bloxcore. This library is modified and was not originally made by bloxcore.
	
	Credit: https://brady-xyz.gitbook.io/maclib-ui-library/information/miscellaneous
]]
...
local assets = {
	...
	bloxcore = "rbxassetid://111305088213502",
...
function MacLib:Window(Settings)
	...
	windowControls.Size = UDim2.new(0, 0, 0, 0)
	...
	information.Position = UDim2.fromOffset(0, 3) -- changed from 31 to 3 since window controls are removed in bloxcore version.
	...
	sidebarGroup.Position = UDim2.fromOffset(0, 46)
	...
	headshot.Image = (isReady and headshotImage) or assets.bloxcore
	...
	function WindowFunctions:TabGroup()
		...
		-- special tab function designed by bloxcore (originally made for join logs)
		function SectionFunctions:CenterTab(Settings)
			local TabFunctions = {Settings = Settings}
			local tabSwitcher = Instance.new("TextButton")
			tabSwitcher.Name = "TabSwitcher"
			tabSwitcher.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json")
			...
			-- instead of doing left and right, its just center.
			...
			center.Position = UDim2.fromScale(0.512, 0)
			center.Size = UDim2.new(0.5, -10, 0, 0)
			...
			function TabFunctions:Section(Settings)
				...
				section.BorderSizePixel = 0
				section.Position = UDim2.fromScale(0, 6.78e-08)
				section.Size = UDim2.fromScale(2, 0) -- increased size to take up entire thing
				section.ClipsDescendants = true
				section.Parent = center -- only center :sigma:
				...
				-- specific element for join logs (removed flag since i dont support config saving)
				function SectionFunctions:Log(Settings)
					--[[
						example for log
						...
						Section:Log({
							...
							UserName <string>
							UserID <number>
							LogType <string: "Join", "Leave", "Present">
						})
					]]
					...
					userAndDisplayFrame.BorderSizePixel = 0
					userAndDisplayFrame.LayoutOrder = 1
					userAndDisplayFrame.Size = UDim2.new(0.95, 0, 0, 32)
					userAndDisplayFrame.Position = UDim2.fromOffset(32, 0)
					...
					userAndDisplayFrame.Parent = log
					
					-- log type

					local logType = Instance.new("Frame")
					logType.Name = "LogType"
					logType.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					logType.BackgroundTransparency = 1
					logType.BorderColor3 = Color3.fromRGB(0, 0, 0)
					logType.BorderSizePixel = 0
					logType.LayoutOrder = 1
					logType.Size = UDim2.new(0.95, 0, 0, 32)
					logType.Position = UDim2.fromOffset(32, 0)

					local userAndDisplayFrameUIPadding = Instance.new("UIPadding")
					userAndDisplayFrameUIPadding.Name = "UserAndDisplayFrameUIPadding"
					userAndDisplayFrameUIPadding.PaddingLeft = UDim.new(0, 8)
					userAndDisplayFrameUIPadding.PaddingTop = UDim.new(0, 3)
					userAndDisplayFrameUIPadding.Parent = logType

					local userAndDisplayFrameUIListLayout = Instance.new("UIListLayout")
					userAndDisplayFrameUIListLayout.Name = "UserAndDisplayFrameUIListLayout"
					userAndDisplayFrameUIListLayout.Padding = UDim.new(0, 1)
					userAndDisplayFrameUIListLayout.SortOrder = Enum.SortOrder.LayoutOrder
					userAndDisplayFrameUIListLayout.VerticalAlignment = Enum.VerticalAlignment.Center
					userAndDisplayFrameUIListLayout.Parent = logType
					...
					if Settings.LogType == "Join" then
						username.Text = "Join"
					elseif Settings.LogType == "Leave" then
						username.Text = "Leave"
					elseif Settings.LogType == "Present" then
					...
					username.BorderSizePixel = 0
					username.LayoutOrder = 1
					username.Parent = logType
					username.Size = UDim2.fromScale(0.975,0)

					logType.Parent = log
					
					local userId = Settings.UserID
					local thumbType = Enum.ThumbnailType.AvatarBust
					local thumbSize = Enum.ThumbnailSize.Size48x48
					local headshotImage, isReady = Players:GetUserThumbnailAsync(userId, thumbType, thumbSize)
				...
				function SectionFunctions:MessageBox(Settings)
					--[[
					...
					uiElements["MessageBox"].Parent = section
					uiElements["MessageBox"].Size = UDim2.new(1, 0, 0, 38)
					uiElements["MessageBox"].LayoutOrder = 2147483647
					uiElements["MessageBox"].BackgroundColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["MessageBox"].AutomaticSize = Enum.AutomaticSize.Y
					uiElements["MessageBox"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["MessageBox"].BorderSizePixel = 0
					uiElements["MessageBox"].LayoutOrder = 2147483647
					uiElements["MessageBox"].BackgroundTransparency = 1

					uiElements["InputBox"].Parent = uiElements["MessageBox"]
					uiElements["InputBox"].Position = UDim2.new(0.8999999761581421, 0, 0.5, 0)
					uiElements["InputBox"].Size = UDim2.new(0.8999999761581421, 0, 0, 32)
					uiElements["InputBox"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["InputBox"].AnchorPoint = Vector2.new(1, 0.5)
					uiElements["InputBox"].AutomaticSize = Enum.AutomaticSize.X
					uiElements["InputBox"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["InputBox"].BorderSizePixel = 0
					uiElements["InputBox"].LayoutOrder = 1
					uiElements["InputBox"].ClipsDescendants = true
					uiElements["InputBox"].BackgroundTransparency = 0.949999988079071
					uiElements["InputBox"].FontFace = Font.new(
						assets.interFont,
						Enum.FontWeight.SemiBold,
						Enum.FontStyle.Normal
					)
					uiElements["InputBox"].TextColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["InputBox"].TextSize = 12
					uiElements["InputBox"].Text = ""
					uiElements["InputBox"].PlaceholderText = Settings.PlaceHolderText or "Type your message and click the arrow to send.."
					uiElements["InputBox"].TextTransparency = 0.10000000149011612
					uiElements["InputBox"].TextXAlignment = Enum.TextXAlignment.Left
					uiElements["InputBox"].ZIndex = 2147483647
					
					function HeaderFunctions:SetText(Text)
						uiElements["InputBox"].Text = Text
					end
					
					function HeaderFunctions:GetText()
						return uiElements["InputBox"].Text
					end
					
					uiElements["InputBox"].FocusLost:Connect(function(EnterPressed)
						if EnterPressed then
							Settings.Callback(HeaderFunctions:GetText())
						end
					end)

					uiElements["InputBoxUICorner"].Parent = uiElements["InputBox"]
					uiElements["InputBoxUICorner"].CornerRadius = UDim.new(0, 4)

					uiElements["InputBoxUIStroke"].Parent = uiElements["InputBox"]
					uiElements["InputBoxUIStroke"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
					uiElements["InputBoxUIStroke"].Color = Color3.fromRGB(255, 255, 255)
					uiElements["InputBoxUIStroke"].Transparency = 0.8999999761581421

					uiElements["InputBoxUIPadding"].Parent = uiElements["InputBox"]
					uiElements["InputBoxUIPadding"].PaddingLeft = UDim.new(0, 5)
					uiElements["InputBoxUIPadding"].PaddingRight = UDim.new(0, 5)

					uiElements["ButtonImage"].Parent = uiElements["MessageBox"]
					uiElements["ButtonImage"].Position = UDim2.new(0.9750000238418579, 0, 0.5, 0)
					uiElements["ButtonImage"].Size = UDim2.new(0, 15, 0, 15)
					uiElements["ButtonImage"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["ButtonImage"].AnchorPoint = Vector2.new(1, 0.5)
					uiElements["ButtonImage"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["ButtonImage"].BorderSizePixel = 0
					uiElements["ButtonImage"].BackgroundTransparency = 1
					uiElements["ButtonImage"].Image = "rbxassetid://10709791437"
					uiElements["ButtonImage"].ImageTransparency = 0.5

					uiElements["ButtonInteract"].Parent = uiElements["MessageBox"]
					uiElements["ButtonInteract"].Position = UDim2.new(0.956, 0, 0.5, 0)
					uiElements["ButtonInteract"].Size = UDim2.new(0, 38, 1, 0)
					uiElements["ButtonInteract"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["ButtonInteract"].AnchorPoint = Vector2.new(0.5, 0.5)
					uiElements["ButtonInteract"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["ButtonInteract"].BorderSizePixel = 0
					uiElements["ButtonInteract"].BackgroundTransparency = 1
					uiElements["ButtonInteract"].FontFace = Font.new(
						assets.interFont,
						Enum.FontWeight.SemiBold,
						Enum.FontStyle.Normal
					)
					uiElements["ButtonInteract"].TextColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["ButtonInteract"].TextSize = 13
					uiElements["ButtonInteract"].RichText = true
					uiElements["ButtonInteract"].Text = ""
					uiElements["ButtonInteract"].TextTransparency = 0.5
					uiElements["ButtonInteract"].TextTruncate = Enum.TextTruncate.AtEnd
					uiElements["ButtonInteract"].TextXAlignment = Enum.TextXAlignment.Left
					
					uiElements["ButtonInteract"].MouseButton1Click:Connect(function()
						Settings.Callback(HeaderFunctions:GetText())
					end)
				...
				function SectionFunctions:Message(Settings)
					--[[
						example for message
					...
					local uiElements = {
						...
						["UserAndDisplayFrameUIPadding_1"] = Instance.new("UIPadding"),
						["Username_1"] = Instance.new("TextLabel"),
						["UserAndDisplayFrameUIListLayout_1"] = Instance.new("UIListLayout")
					}

					uiElements["Message"].Parent = section
					uiElements["Message"].Name = "not localplayer mesage"
					uiElements["Message"].Size = UDim2.new(1, 0, 0, 84)
					uiElements["Message"].BackgroundColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Message"].AutomaticSize = Enum.AutomaticSize.Y
					...
					uiElements["UIPadding"].PaddingBottom = UDim.new(0, 5)
					...
					uiElements["Headshot"].Parent = uiElements["Message"]
					uiElements["Headshot"].Size = UDim2.new(0, 32, 0, 32)
					uiElements["Headshot"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Headshot"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Headshot"].BorderSizePixel = 0
					uiElements["Headshot"].BackgroundTransparency = 1
					uiElements["Headshot"].Image = (isReady and headshotImage) or assets.bloxcore

					uiElements["UICorner"].Parent = uiElements["Headshot"]
					uiElements["UICorner"].CornerRadius = UDim.new(1, 0)

					uiElements["BaseUIStroke"].Parent = uiElements["Headshot"]
					uiElements["BaseUIStroke"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
					uiElements["BaseUIStroke"].Color = Color3.fromRGB(255, 255, 255)
					uiElements["BaseUIStroke"].Transparency = 0.8999999761581421

					uiElements["UserAndDisplayFrame"].Parent = uiElements["Message"]
					uiElements["UserAndDisplayFrame"].Position = UDim2.new(0, 32, 0, 0)
					uiElements["UserAndDisplayFrame"].Size = UDim2.new(0.949999988079071, 0, 0, 32)
					uiElements["UserAndDisplayFrame"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["UserAndDisplayFrame"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["UserAndDisplayFrame"].BorderSizePixel = 0
					uiElements["UserAndDisplayFrame"].LayoutOrder = 1
					uiElements["UserAndDisplayFrame"].BackgroundTransparency = 1

					uiElements["DisplayName"].Parent = uiElements["UserAndDisplayFrame"]
					uiElements["DisplayName"].Size = UDim2.new(1, 0, 0, 0)
					uiElements["DisplayName"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["DisplayName"].AutomaticSize = Enum.AutomaticSize.XY
					uiElements["DisplayName"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["DisplayName"].BorderSizePixel = 0
					uiElements["DisplayName"].BackgroundTransparency = 1
					uiElements["DisplayName"].FontFace = Font.new(
						assets.interFont,
						Enum.FontWeight.SemiBold,
						Enum.FontStyle.Normal
					)
					uiElements["DisplayName"].TextColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["DisplayName"].TextSize = 13
					uiElements["DisplayName"].Text = Settings.DisplayName
					uiElements["DisplayName"].TextTransparency = 0.10000000149011612
					uiElements["DisplayName"].TextTruncate = Enum.TextTruncate.SplitWord
					uiElements["DisplayName"].TextXAlignment = Enum.TextXAlignment.Left

					uiElements["UserAndDisplayFrameUIPadding"].Parent = uiElements["UserAndDisplayFrame"]
					uiElements["UserAndDisplayFrameUIPadding"].PaddingTop = UDim.new(0, 3)
					uiElements["UserAndDisplayFrameUIPadding"].PaddingLeft = UDim.new(0, 8)

					uiElements["UserAndDisplayFrameUIListLayout"].Parent = uiElements["UserAndDisplayFrame"]
					uiElements["UserAndDisplayFrameUIListLayout"].Padding = UDim.new(0, 1)
					uiElements["UserAndDisplayFrameUIListLayout"].SortOrder = Enum.SortOrder.LayoutOrder

					uiElements["Username"].Parent = uiElements["UserAndDisplayFrame"]
					uiElements["Username"].Size = UDim2.new(1, 0, 0, 0)
					uiElements["Username"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Username"].AutomaticSize = Enum.AutomaticSize.XY
					uiElements["Username"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Username"].BorderSizePixel = 0
					uiElements["Username"].LayoutOrder = 1
					uiElements["Username"].BackgroundTransparency = 1
					uiElements["Username"].FontFace = Font.new(
						assets.interFont,
						Enum.FontWeight.SemiBold,
						Enum.FontStyle.Normal
					)
					uiElements["Username"].TextColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Username"].TextSize = 12
					uiElements["Username"].Text = "@" .. Settings.UserName
					uiElements["Username"].TextTransparency = 0.699999988079071
					uiElements["Username"].TextTruncate = Enum.TextTruncate.SplitWord
					uiElements["Username"].TextXAlignment = Enum.TextXAlignment.Left

					uiElements["Message_1"].Parent = uiElements["Message"]
					uiElements["Message_1"].Position = UDim2.new(0, 32, 1, 0)
					uiElements["Message_1"].Size = UDim2.new(0.949999988079071, 0, 0, 32)
					uiElements["Message_1"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Message_1"].AnchorPoint = Vector2.new(0, 1)
					uiElements["Message_1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Message_1"].BorderSizePixel = 0
					uiElements["Message_1"].LayoutOrder = 1
					uiElements["Message_1"].BackgroundTransparency = 1

					uiElements["UserAndDisplayFrameUIPadding_1"].Parent = uiElements["Message_1"]
					uiElements["UserAndDisplayFrameUIPadding_1"].PaddingTop = UDim.new(0, 3)
					uiElements["UserAndDisplayFrameUIPadding_1"].PaddingLeft = UDim.new(0, -32)

					uiElements["Username_1"].Parent = uiElements["Message_1"]
					uiElements["Username_1"].Position = UDim2.new(0.030977735295891762, 0, -0.3017241358757019, 0)
					uiElements["Username_1"].Size = UDim2.new(0.969022274017334, 0, 1.0517241954803467, 16)
					uiElements["Username_1"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Username_1"].AutomaticSize = Enum.AutomaticSize.XY
					uiElements["Username_1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Username_1"].BorderSizePixel = 0
					uiElements["Username_1"].LayoutOrder = 1
					uiElements["Username_1"].BackgroundTransparency = 1
					uiElements["Username_1"].FontFace = Font.new(
						assets.interFont,
						Enum.FontWeight.SemiBold,
						Enum.FontStyle.Normal
					)
					uiElements["Username_1"].TextColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Username_1"].TextSize = 14
					uiElements["Username_1"].Text = Settings.Text
					uiElements["Username_1"].TextTransparency = 0.3499999940395355
					uiElements["Username_1"].TextTruncate = Enum.TextTruncate.SplitWord
					uiElements["Username_1"].TextWrapped = true
					uiElements["Username_1"].TextXAlignment = Enum.TextXAlignment.Left

					uiElements["UserAndDisplayFrameUIListLayout_1"].Parent = uiElements["Message_1"]
					uiElements["UserAndDisplayFrameUIListLayout_1"].Padding = UDim.new(0, 1)
					uiElements["UserAndDisplayFrameUIListLayout_1"].HorizontalAlignment = Enum.HorizontalAlignment.Right
					uiElements["UserAndDisplayFrameUIListLayout_1"].SortOrder = Enum.SortOrder.LayoutOrder
					uiElements["UserAndDisplayFrameUIListLayout_1"].VerticalAlignment = Enum.VerticalAlignment.Center

					return HeaderFunctions
				end
				
				function SectionFunctions:MessageLP(Settings)
					--[[
						example for messagelp (localplayer ver)
					...
					local uiElements = {
						["MessageLP-RIGHT"] = Instance.new("Frame"),
						["UIPadding_1"] = Instance.new("UIPadding"),
						["Headshot_1"] = Instance.new("ImageLabel"),
						["UICorner_1"] = Instance.new("UICorner"),
						["BaseUIStroke_1"] = Instance.new("UIStroke"),
						["UserAndDisplayFrame_1"] = Instance.new("Frame"),
						["DisplayName_1"] = Instance.new("TextLabel"),
						["UserAndDisplayFrameUIPadding_2"] = Instance.new("UIPadding"),
						["UserAndDisplayFrameUIListLayout_2"] = Instance.new("UIListLayout"),
						["Username_2"] = Instance.new("TextLabel"),
						["Message_2"] = Instance.new("Frame"),
						["UserAndDisplayFrameUIPadding_3"] = Instance.new("UIPadding"),
						["Username_3"] = Instance.new("TextLabel"),
						["UserAndDisplayFrameUIListLayout_3"] = Instance.new("UIListLayout")
					}

					uiElements["MessageLP-RIGHT"].Parent = section
					uiElements["MessageLP-RIGHT"].Size = UDim2.new(1, 0, 0, 84)
					uiElements["MessageLP-RIGHT"].Name = "localplayer mesage"
					uiElements["MessageLP-RIGHT"].BackgroundColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["MessageLP-RIGHT"].AutomaticSize = Enum.AutomaticSize.Y
					uiElements["MessageLP-RIGHT"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["MessageLP-RIGHT"].BorderSizePixel = 0
					uiElements["MessageLP-RIGHT"].BackgroundTransparency = 1

					uiElements["UIPadding_1"].Parent = uiElements["MessageLP-RIGHT"]
					uiElements["UIPadding_1"].PaddingBottom = UDim.new(0, 5)
					...
					uiElements["Headshot_1"].Parent = uiElements["MessageLP-RIGHT"]
					uiElements["Headshot_1"].Position = UDim2.new(1, 0, 0, 0)
					uiElements["Headshot_1"].Size = UDim2.new(0, 32, 0, 32)
					uiElements["Headshot_1"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Headshot_1"].AnchorPoint = Vector2.new(1, 0)
					uiElements["Headshot_1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Headshot_1"].BorderSizePixel = 0
					uiElements["Headshot_1"].BackgroundTransparency = 1
					uiElements["Headshot_1"].Image = (isReady and headshotImage) or assets.bloxcore

					uiElements["UICorner_1"].Parent = uiElements["Headshot_1"]
					uiElements["UICorner_1"].CornerRadius = UDim.new(1, 0)

					uiElements["BaseUIStroke_1"].Parent = uiElements["Headshot_1"]
					uiElements["BaseUIStroke_1"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
					uiElements["BaseUIStroke_1"].Color = Color3.fromRGB(255, 255, 255)
					uiElements["BaseUIStroke_1"].Transparency = 0.8999999761581421

					uiElements["UserAndDisplayFrame_1"].Parent = uiElements["MessageLP-RIGHT"]
					uiElements["UserAndDisplayFrame_1"].Position = UDim2.new(0, 32, 0, 0)
					uiElements["UserAndDisplayFrame_1"].Size = UDim2.new(0.949999988079071, 0, 0, 32)
					uiElements["UserAndDisplayFrame_1"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["UserAndDisplayFrame_1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["UserAndDisplayFrame_1"].BorderSizePixel = 0
					uiElements["UserAndDisplayFrame_1"].LayoutOrder = 1
					uiElements["UserAndDisplayFrame_1"].BackgroundTransparency = 1

					uiElements["DisplayName_1"].Parent = uiElements["UserAndDisplayFrame_1"]
					uiElements["DisplayName_1"].Size = UDim2.new(0.9045120477676392, 0, 0.4482758641242981, 0)
					uiElements["DisplayName_1"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["DisplayName_1"].AutomaticSize = Enum.AutomaticSize.XY
					uiElements["DisplayName_1"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["DisplayName_1"].BorderSizePixel = 0
					uiElements["DisplayName_1"].BackgroundTransparency = 1
					uiElements["DisplayName_1"].FontFace = Font.new(
						assets.interFont,
						Enum.FontWeight.SemiBold,
						Enum.FontStyle.Normal
					)
					uiElements["DisplayName_1"].TextColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["DisplayName_1"].TextSize = 13
					uiElements["DisplayName_1"].Text = Players.LocalPlayer.DisplayName
					uiElements["DisplayName_1"].TextTransparency = 0.10000000149011612
					uiElements["DisplayName_1"].TextTruncate = Enum.TextTruncate.SplitWord
					uiElements["DisplayName_1"].TextXAlignment = Enum.TextXAlignment.Right

					uiElements["UserAndDisplayFrameUIPadding_2"].Parent = uiElements["UserAndDisplayFrame_1"]
					uiElements["UserAndDisplayFrameUIPadding_2"].PaddingTop = UDim.new(0, 3)
					uiElements["UserAndDisplayFrameUIPadding_2"].PaddingLeft = UDim.new(0, 8)

					uiElements["UserAndDisplayFrameUIListLayout_2"].Parent = uiElements["UserAndDisplayFrame_1"]
					uiElements["UserAndDisplayFrameUIListLayout_2"].Padding = UDim.new(0, 1)
					uiElements["UserAndDisplayFrameUIListLayout_2"].SortOrder = Enum.SortOrder.LayoutOrder

					uiElements["Username_2"].Parent = uiElements["UserAndDisplayFrame_1"]
					uiElements["Username_2"].Position = UDim2.new(0, 0, 0.48275861144065857, 0)
					uiElements["Username_2"].Size = UDim2.new(0.9045120477676392, 0, 0.4137931168079376, 0)
					uiElements["Username_2"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Username_2"].AutomaticSize = Enum.AutomaticSize.XY
					uiElements["Username_2"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Username_2"].BorderSizePixel = 0
					uiElements["Username_2"].LayoutOrder = 1
					uiElements["Username_2"].BackgroundTransparency = 1
					uiElements["Username_2"].FontFace = Font.new(
						assets.interFont,
						Enum.FontWeight.SemiBold,
						Enum.FontStyle.Normal
					)
					uiElements["Username_2"].TextColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Username_2"].TextSize = 12
					uiElements["Username_2"].Text = "@" .. Players.LocalPlayer.Name
					uiElements["Username_2"].TextTransparency = 0.699999988079071
					uiElements["Username_2"].TextTruncate = Enum.TextTruncate.SplitWord
					uiElements["Username_2"].TextXAlignment = Enum.TextXAlignment.Right

					uiElements["Message_2"].Parent = uiElements["MessageLP-RIGHT"]
					uiElements["Message_2"].Position = UDim2.new(0, 32, 1, 0)
					uiElements["Message_2"].Size = UDim2.new(0.949999988079071, 0, 0, 32)
					uiElements["Message_2"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Message_2"].AnchorPoint = Vector2.new(0, 1)
					uiElements["Message_2"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Message_2"].BorderSizePixel = 0
					uiElements["Message_2"].LayoutOrder = 1
					uiElements["Message_2"].BackgroundTransparency = 1

					uiElements["UserAndDisplayFrameUIPadding_3"].Parent = uiElements["Message_2"]
					uiElements["UserAndDisplayFrameUIPadding_3"].PaddingTop = UDim.new(0, 3)
					uiElements["UserAndDisplayFrameUIPadding_3"].PaddingLeft = UDim.new(0, -32)

					uiElements["Username_3"].Parent = uiElements["Message_2"]
					uiElements["Username_3"].Position = UDim2.new(0, 0, -0.3017241358757019, 0)
					uiElements["Username_3"].Size = UDim2.new(0.9627299308776855, 0, 1.0517241954803467, 16)
					uiElements["Username_3"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Username_3"].AutomaticSize = Enum.AutomaticSize.XY
					uiElements["Username_3"].BorderColor3 = Color3.fromRGB(0, 0, 0)
					uiElements["Username_3"].BorderSizePixel = 0
					uiElements["Username_3"].LayoutOrder = 1
					uiElements["Username_3"].BackgroundTransparency = 1
					uiElements["Username_3"].FontFace = Font.new(
						assets.interFont,
						Enum.FontWeight.SemiBold,
						Enum.FontStyle.Normal
					)
					uiElements["Username_3"].TextColor3 = Color3.fromRGB(255, 255, 255)
					uiElements["Username_3"].TextSize = 14
					uiElements["Username_3"].Text = Settings.Text
					uiElements["Username_3"].TextTransparency = 0.3499999940395355
					uiElements["Username_3"].TextTruncate = Enum.TextTruncate.SplitWord
					uiElements["Username_3"].TextWrapped = true
					uiElements["Username_3"].TextXAlignment = Enum.TextXAlignment.Right

					uiElements["UserAndDisplayFrameUIListLayout_3"].Parent = uiElements["Message_2"]
					uiElements["UserAndDisplayFrameUIListLayout_3"].Padding = UDim.new(0, 1)
					uiElements["UserAndDisplayFrameUIListLayout_3"].SortOrder = Enum.SortOrder.LayoutOrder
					uiElements["UserAndDisplayFrameUIListLayout_3"].VerticalAlignment = Enum.VerticalAlignment.Center
